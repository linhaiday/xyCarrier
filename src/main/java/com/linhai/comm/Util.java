...
public class Util {
     ...
     * @return
     */
    public static String monthsBefore(int month){
    ...
    public static String year(String date){
        return String.format("%tY",Util.toDate(date));
    }
    ...
    public static String month(String date){
        return String.format("%tm",Util.toDate(date));
    }
    ...
    public static String yearMonth(String date){
        return String.format("%tY",Util.toDate(date))+"-"+String.format("%tm",Util.toDate(date));
    }
    ...
    public static String yearMonthDay(String date){
        return String.format("%tY",Util.toDate(date))+"-"+String.format("%tm",Util.toDate(date))+"-"+String.format("%td",Util.toDate(date));
    }
